...
type Navigation = CompositeNavigationProp<StackNavigationProp<MapStackParamList>, DrawerNavigationProp<MainDrawerParamList>>;
    ...
    return (
        <View>
            <>
                ...
                <Pressable style={[styles.drawerButton, {top: inset.top || 20}]} onPress={() => {
